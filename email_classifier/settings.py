...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="email_db"),   # database name
        "USER": config("DB_USER", default="postgres"),           # your postgres user
        "PASSWORD": config("DB_PASSWORD", default=""),   # your postgres password
...
# Default user model (we’ll customize later)
